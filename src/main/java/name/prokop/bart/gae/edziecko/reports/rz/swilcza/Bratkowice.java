...
public class Bratkowice extends DzienPobytuDziecka {
    ...
    public Bratkowice(KidsReport raport, Dziecko dziecko, Date date, NavigableSet<Zdarzenie> entries,Map<String, Object> shared) {
