 ...
 */
package name.prokop.bart.gae.edziecko;
...
//		response.println("onEnter request.getUserPrincipal(): " + request.getUserPrincipal());
//		if (request.getUserPrincipal() != null)
//			response.println("onEnter request.getUserPrincipal().getName(): " + request.getUserPrincipal().getName());
//		response.println("onEnter request.getSession().getAttribute(LoginHelper.LOGOUT_URL):\n", request.getLogoutUrl());
//		response.println("onEnter request.getSession().getAttribute(LoginHelper.SESSION_PRZEDSZKOLE_ID): " + request.getPrzedszkoleKey());
//		response.println("---------------------------------------------");
	}
