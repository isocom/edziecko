...
public class Swilcza extends DzienPobytuDziecka {
    ...
    public Swilcza(KidsReport raport, Dziecko dziecko, Date date, NavigableSet<Zdarzenie> entries, Map<String, Object> shared) {
        ...
        TENDF = DateToolbox.getBeginingOfDay(date, 13 * HOUR + 05 * MIN);
